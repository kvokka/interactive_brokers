...
RSpec.describe InteractiveBrokersGenerator::Reflection::IbField do
  subject(:ib_class) { InteractiveBrokersGenerator::Reflection::IbClass.new(Java::ComIbClient::Contract) }
  ...
  def field(name)
    InteractiveBrokersGenerator::Reflection::IbField.new(find_field(name), ib_class)
  end
