...
RSpec.describe InteractiveBrokers::Generators::ClassSourceGenerator do
  describe "#ruby_class_source_for" do
    it "generates a valid ruby object for a simple ib value object class" do
      evaluate_generated_source_for Contract, namespace: "InteractiveBrokers::Common::Test1"
      contract = InteractiveBrokers::Common::Test1::Contract.new(last_trade_date_or_contract_month:
                                                                  "2018-2-4")
  ...
  describe "Extended ib class" do
    before(:context) do
      evaluate_generated_source_for Contract, namespace: "InteractiveBrokers::Common::Test2"
    end
    ...
    describe "#to_ruby" do
      it "adds a method to ruby that converts the ib object into a ruby object" do
        ...
        expect(ruby_contract).to be_instance_of(InteractiveBrokers::Common::Test2::Contract)
  ...
  describe "Generated ruby class" do
    before(:context) do
      evaluate_generated_source_for Contract, ComboLeg, namespace: "InteractiveBrokers::Common::Test3"
    end

    let(:namespace) { InteractiveBrokers::Common::Test3 }
    ...
    describe "#to_ib" do
      ...
      it "supports converting arrays of objects" do
        ruby_contract = InteractiveBrokers::Common::Test3::Contract.new
